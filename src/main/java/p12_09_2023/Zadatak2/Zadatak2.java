...
public class Zadatak2 {
    public static void main(String[] args) {
        ...
        host.setFullName("Dusan Stevanovic");
        host.subscribe(100);

        Korisnik guest = new Korisnik();
        guest.setFullName("Petar Petrovic");
        guest.subscribe(200);

        ZoomCall firstCall = new ZoomCall("zoom.us/2154515", "Wdkdx123",host);
        firstCall.setGuestUser(host);
