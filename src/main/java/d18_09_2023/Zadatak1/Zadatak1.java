...
public class Zadatak1 {
    public static void main(String[] args) {
        ...
        VideoPlayer videoPlayer = new VideoPlayer(280,74,15,720);

        TimeControl timeControl = new TimeControl(true);
        timeControl.makeAction(videoPlayer);
        videoPlayer.print();

        AudioControl audioControl = new AudioControl(false);
        audioControl.makeAction(videoPlayer);
        videoPlayer.print();

        QualityOptimizerControl qualityControl = new QualityOptimizerControl(75);
        qualityControl.makeAction(videoPlayer);
        videoPlayer.print();
    }
}
