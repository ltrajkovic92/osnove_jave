...
public class Zadatak2 {
    public static void main(String[] args) {
        ...
        EmailValidator emailValidator = new EmailValidator("dusan@gmail.c");

        PasswordValidator passwordValidator = new PasswordValidator("wdaDsa");

        PhoneValidator phoneValidator = new PhoneValidator("444 22a22222");

        ValidationResult email = emailValidator.validate();
        email.print();
        System.out.println();
        ValidationResult password = passwordValidator.validate();
        password.print();
        System.out.println();
        ValidationResult phone = phoneValidator.validate();
        phone.print();
    }
}
