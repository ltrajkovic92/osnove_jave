...
public class Zadatak1 {
    public static void main(String[] args) {
        ...
        //Dana (dan.mesec.godina.)god sklopljen je ugovor izmedju (print prodavca) i (print kupca) o kupovini nekretnine (adresa) po ceni od (cena nekretnin)
        //pri cemu je kupac u obavezi da agenciji isplati novcanu vrednost u iznosu od (zarada agencije)

        FizickoLice seller = new FizickoLice("Petar Petrovic", 5454544, "123384654333");
        FizickoLice buyer = new FizickoLice("Nebojsa Mitrovix",5423232,"565465656555");
        buyer.setWasAlreadyCustomer(true);

        Ugovor contract = new Ugovor("12.09.2023 14:23",seller,buyer,20000, "Bulevar Nikole Tesle 18, Nis");
