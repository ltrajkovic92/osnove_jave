...
public class Zadatak1 {
    public static void main(String[] args) {
        ...
        Student first = new Student("Djordje Jovanovic","42415156",12,3000);
        first.print();

        first.pay(500);
        first.print();

        Student second = new Student("Dusan Stanojevic","521181",13,5000);
        second.print();

        Profesor profesor = new Profesor("Milan Savic","655654564","Matematika", 50000);
        profesor.print();

        profesor.povecajPlatu(10);
        profesor.print();
    }
}
