...
public class Zadatak4 {
    public static void main(String[] args) {
        ...
        int x3 = s.nextInt();
        System.out.print("Unestie y za M: ");
        int y3 = s.nextInt();
        ...
        //Napisati program koji proverava da li je kliknuto u okviru login forme za web stranicu. Korisnik unosi x i y koordinate za T1, T2 i M.
