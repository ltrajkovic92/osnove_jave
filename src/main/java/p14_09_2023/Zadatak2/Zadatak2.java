...
public class Zadatak2 {
    public static void main(String[] args) {
        ...
        FacebookPost firstPost = new FacebookPost("Djordje Jovanovic", "Neki tekst");

        Reakcija firstReaction = new Reakcija("like","Dusan Stanojevic");
        Reakcija secondReaction = new Reakcija("like","Milan Trajkovic");
        Reakcija thirdReaction = new Reakcija("smajli","Dusan Popovic");

        firstPost.react(firstReaction);
        firstPost.react(secondReaction);
        firstPost.react(thirdReaction);
