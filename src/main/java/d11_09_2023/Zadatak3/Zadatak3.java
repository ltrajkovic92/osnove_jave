...
public class Zadatak3 {
    public static void main(String[] args) {
        ...
        Video firstVideo = new Video("ypbjIwbTR8c","David A. Stewart - Lily Was Here ft. Candy Dulfer", 263);
        ...
        YoutubePlayer firstPlayer = new YoutubePlayer();
        firstPlayer.read();
        System.out.println();
        firstPlayer.setQuality(8);
        firstPlayer.activateMiniPlayerMode();
        firstPlayer.loadVideo(firstVideo);
        firstPlayer.fastForward();
        firstPlayer.fastForward();
        firstPlayer.fastForward();
        firstPlayer.rewind();

       firstPlayer.read();
        System.out.println(firstPlayer.share());
